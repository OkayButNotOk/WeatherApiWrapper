...
namespace WeatherApiWrapper.Models
{
    public class WeatherResponse
    {
        ...
        [JsonPropertyName("dt")] public long? Dt { get; set; }                 // Unix time (saniye)
        [JsonPropertyName("sys")] public Sys? Sys { get; set; }
        [JsonPropertyName("timezone")] public int? Timezone { get; set; }      // saniye
    ...
    public class Main
    {
        ...
        [JsonPropertyName("feels_like")] public double? FeelsLike { get; set; }   // alt çizgi!
    ...
    public class Sys
    {
        ...
        [JsonPropertyName("sunrise")] public long? Sunrise { get; set; }   // Unix time
        [JsonPropertyName("sunset")] public long? Sunset { get; set; }     // Unix time
    }
}
